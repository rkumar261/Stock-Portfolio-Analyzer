...
public class PortfolioManagerApplication {
  ...
  public static List<AnnualizedReturn> mainCalculateSingleReturn(String[] args)
      ...
      for(int i=0; i<listSize; i++){
        ...
        annualizedReturns.add(calculateAnnualizedReturns((LocalDate.parse(args[1])), portfolioTrades[i], buyPrice, sellPrice));
      }
  ...
  public static AnnualizedReturn calculateAnnualizedReturns(LocalDate endDate,
      ...
      Double annualizedReturn = Math.pow((1 + totalReturn), (1.0/(diff.getYears()))) - 1;
  ...
  private static void listOfTradeObject(PortfolioTrade[] portFolioTrade, ArrayList<TotalReturnsDto> totalReturnsDtos,
      int i, List<TiingoCandle> collection) {

    Candle last = collection.get(collection.size() - 1);
    Candle first = collection.get(0);
    totalReturnsDtos.add(new TotalReturnsDto(portFolioTrade[i].getSymbol(), last.getClose(), first.getOpen()));
  }
  ...
  public static PortfolioTrade[] portFolioData(String[] args) throws IOException, URISyntaxException {
